#!/usr/bin/env bash
# Theme Everforest Dark Hard for tmux
# Modified from tokyonight.nvim's tmux extra

# Define colors
# From: https://github.com/sainnhe/everforest/blob/master/palette.md
# Group Default
FG_DEFAULT="#859289"
BG_DEFAULT="#2e383c"
# Group Highlight 1
FG_HIGHLIGHT_1="#272e33"
BG_HIGHLIGHT_1="#a7c080"
# Group Highlight 2
FG_HIGHLIGHT_2="#9da9a0"
BG_HIGHLIGHT_2="#414b50"
